...
namespace takip.Migrations
{
    ...
    [Migration("20251016181446_AddFireProductAndIdleTime")]
    partial class AddFireProductAndIdleTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("takip.Models.ActiveShift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("IdleTimeSeconds")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("StartDm452Value")
                        .HasColumnType("integer");

                    b.Property<int>("StartFireProductCount")
                        .HasColumnType("integer");

                    b.Property<int>("StartTotalProduction")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_ActiveShift_IsActive");

                    b.HasIndex("OperatorName")
                        .HasDatabaseName("IX_ActiveShift_OperatorName");

                    b.HasIndex("ShiftStartTime")
                        .HasDatabaseName("IX_ActiveShift_ShiftStartTime");

                    b.ToTable("ActiveShifts");
                });
            ...
            modelBuilder.Entity("takip.Models.ShiftMoldRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("EndProductionCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("StartProductionCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("takip.Models.ShiftRecord", b =>
                {
                    ...
                    b.Property<string>("Mixer1MaterialsJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("Mixer2MaterialsJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("TotalMaterialsJson")
                        .IsRequired()
                        .HasColumnType("text");
